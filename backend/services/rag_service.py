...
"""
    ...
    if api_key:
        try:
            ...
            system = f"""You are StudyBridge AI — an expert, encouraging study-abroad and higher education advisor.
...
"""
    ...
    return {
        "answer": ans,
        "sources": sources if sources else ["StudyBridge Curated Higher Education Knowledge Graph"]
    }
